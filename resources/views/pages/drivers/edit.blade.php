...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('drivers.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
            ...
            <div class="card-body">
                <form action="{{ route('drivers.update',$driver->id) }}" method="POST">
                    ...
                    <div class="for-group mb-3">
                        ...
                        <input type="text" name="fname" value="{{ $driver->fname }}" class="form-control">
