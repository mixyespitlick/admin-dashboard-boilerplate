        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-10">
                            <h5>SERVICE PROVIDER TYPES</h5>
                            <span>List of Service Provider Types</span>
                        </div>
                        <div class="col-sm-2 text-right">
                            {{-- <i class="icofont icofont-ui-edit"></i> --}}
                            <a href="{{ route('service_provider_types.create') }}" class="btn btn-sm btn-primary">
                                Create
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered" cellspacing="0" id="serviceProviderType">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $serviceProviderType->description }}
                                    </td>
                                    <td>
                                        {{ $serviceProviderType->status }}
                                    </td>
                                    <td>
                                        <form
                                            action="{{ route('service_provider_types.destroy',$serviceProviderType->id) }}"
                                            method="POST">
                                            <a href="{{ route('service_provider_types.edit',$serviceProviderType->id) }}"
