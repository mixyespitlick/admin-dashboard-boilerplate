                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-10">
                            ...
                            <span>List of Collection Points</span>
                        </div>
                        <div class="col-sm-2 text-right">
                            {{-- <i class="icofont icofont-ui-edit"></i> --}}
                            <a href="{{ route('collection_points.create') }}" class="btn btn-sm btn-primary">
                                Create
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered" cellspacing="0" id="serviceProviderType">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $collectionPoint->area->name }}
                                    </td>
                                    <td>
                                        {{ $collectionPoint->status ? 'Enabled' : 'Disabled'}}
                                    </td>
                                    <td>
                                        <form action="{{ route('collection_points.destroy',$collectionPoint->id) }}"
                                            method="POST">
                                            <a href="{{ route('collection_points.edit',$collectionPoint->id) }}"
