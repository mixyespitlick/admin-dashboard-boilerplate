                  ...
                  <ul class="show-notification row">
                    ...
                    <li class="col-sm-3">
                      ...
                      <div class="row m-b-20">
                        <div class="col-sm-4">
                          <img class="img-fluid img-thumbnail" src="assets/images/mega-menu/01.jpg" alt="Gallery-1" />
                        </div>
                        <div class="col-sm-4">
                          <img class="img-fluid img-thumbnail" src="assets/images/mega-menu/02.jpg" alt="Gallery-2" />
                        </div>
                        <div class="col-sm-4">
                          <img class="img-fluid img-thumbnail" src="assets/images/mega-menu/03.jpg" alt="Gallery-3" />
                        </div>
                      </div>
                      <div class="row m-b-20">
                        <div class="col-sm-4">
                          <img class="img-fluid img-thumbnail" src="assets/images/mega-menu/04.jpg" alt="Gallery-4" />
                        </div>
                        <div class="col-sm-4">
                          <img class="img-fluid img-thumbnail" src="assets/images/mega-menu/05.jpg" alt="Gallery-5" />
                        </div>
                        <div class="col-sm-4">
                          <img class="img-fluid img-thumbnail" src="assets/images/mega-menu/06.jpg" alt="Gallery-6" />
                        </div>
                      </div>
        ...
        <div class="pcoded-wrapper">
          <nav class="pcoded-navbar" pcoded-header-position="relative">
            ...
            <div class="pcoded-inner-navbar main-menu">
              ...
              <div class="pcoded-navigatio-lavel" data-i18n="nav.category.tables" menu-title-theme="theme5">
                Tables
              </div>
              <ul class="pcoded-item pcoded-left-item">
                <li class="pcoded-hasmenu">
              ...
              <div class="pcoded-navigatio-lavel" data-i18n="nav.category.pages" menu-title-theme="theme5">
                Pages
              </div>
              <ul class="pcoded-item pcoded-left-item">
                <li class="pcoded-hasmenu">
              ...
              <div class="pcoded-navigatio-lavel" data-i18n="nav.category.other" menu-title-theme="theme5">
                Other
              </div>
              <ul class="pcoded-item pcoded-left-item">
                <li class="pcoded-hasmenu">
                                  ...
                                  <li class="selected" data-date="16/01/2014">
                                    ...
                                    <div class="m-t-20 d-timeline-btn">
                                      ...
                                      <button class="btn btn-primary f-right">
                                        <i class="icofont icofont-plus m-r-0"></i>
                                      </button>
                                    </div>
                                  </li>
                            ...
                            <div class="card card-border-primary">
                              ...
                              <div class="card-footer">
                                <div class="task-list-table">
                                  <p class="task-due">
                                    <strong> Due : </strong><strong class="label label-success">23 hours</strong>
                                  </p>
                                </div>
                                <div class="task-board m-0">
                                  <a href="http://flatable.phoenixcoded.net/html/invoice.html"
                                    class="btn btn-info btn-mini b-none"><i class="icofont icofont-eye-alt m-0"></i></a>
                          ...
                          <div class="col-lg-12">
                            <div class="card card-border-primary">
                              ...
                              <div class="card-footer">
                                <div class="task-list-table">
                                  <p class="task-due">
                                    <strong> Due : </strong><strong class="label label-warning">23 hours</strong>
                                  </p>
                                </div>
                                <div class="task-board m-0">
                                  <a href="http://flatable.phoenixcoded.net/html/invoice.html"
