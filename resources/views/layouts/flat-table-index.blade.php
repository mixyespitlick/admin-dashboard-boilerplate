...
<html lang="en">
  ...
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="assets/pages/flag-icon/flag-icon.min.css"
    />
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="assets/pages/dashboard/amchart/css/amchart.css"
    />
  ...
  <body>
                    ...
                    <ul class="show-notification row">
                      <li class="col-sm-3">
                        ...
                        <ul class="mega-menu-links">
                          ...
                          <li>
                            <a href="user-profile.html">User Information</a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="#" class="media">
                              ...
                              <div class="media-body">
                                <h5>Location</h5>
                                <small class="text-muted"
                                  >Find Your Location with ease of use</small
                                >
                              </div>
                            </a>
                          </li>
                      ...
                      <li class="col-sm-3">
                        ...
                        <div class="row m-b-20">
                          <div class="col-sm-4">
                            <img
                              ...
                              src="assets/images/mega-menu/01.jpg"
                              alt="Gallery-1"
                            />
                          </div>
                          <div class="col-sm-4">
                            <img
                              class="img-fluid img-thumbnail"
                              src="assets/images/mega-menu/02.jpg"
                              alt="Gallery-2"
                            />
                          </div>
                          <div class="col-sm-4">
                            <img
                              class="img-fluid img-thumbnail"
                              src="assets/images/mega-menu/03.jpg"
                              alt="Gallery-3"
                            />
                          </div>
                        </div>
                        <div class="row m-b-20">
                          <div class="col-sm-4">
                            <img
                              class="img-fluid img-thumbnail"
                              src="assets/images/mega-menu/04.jpg"
                              alt="Gallery-4"
                            />
                          </div>
                          <div class="col-sm-4">
                            <img
                              class="img-fluid img-thumbnail"
                              src="assets/images/mega-menu/05.jpg"
                              alt="Gallery-5"
                            />
                          </div>
                          <div class="col-sm-4">
                            <img
                              class="img-fluid img-thumbnail"
                              src="assets/images/mega-menu/06.jpg"
                              alt="Gallery-6"
                            />
                          </div>
                        </div>
                ...
                <div class="main-friend-list">
                  ...
                  >
                    <a class="media-left" href="#!">
                      <img
                        class="media-object img-circle"
                        src="assets/images/task/task-u1.jpg"
                        alt="Generic placeholder image"
                      />
                      <div class="live-status bg-success"></div>
                    </a>
                  ...
                  >
                    <a class="media-left" href="#!">
                      <img
                        class="media-object img-circle"
                        src="assets/images/task/task-u2.jpg"
                        alt="Generic placeholder image"
                      />
                      <div class="live-status bg-success"></div>
                    </a>
                  ...
                  >
                    <a class="media-left" href="#!">
                      <img
                        class="media-object img-circle"
                        src="assets/images/task/task-u3.jpg"
                        alt="Generic placeholder image"
                      />
                      <div class="live-status bg-success"></div>
                    </a>
          ...
          <div class="pcoded-wrapper">
            <nav class="pcoded-navbar" pcoded-header-position="relative">
              ...
              <div class="pcoded-inner-navbar main-menu">
                ...
                <ul class="pcoded-item pcoded-left-item">
                  ...
                  <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)">
                      ...
                      <span
                        class="pcoded-mtext"
                        data-i18n="nav.page_layout.main"
                        >Page layouts</span
                      >
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <ul class="pcoded-submenu">
                          ...
                          <li class="">
                            <a
                              ...
                              data-i18n="nav.page_layout.vertical.header-fixed"
                            >
                              <span class="pcoded-micon"
                                ><i class="icon-chart"></i
                              ></span>
                          ...
                          <li class="">
                            <a
                              ...
                              data-i18n="nav.page_layout.vertical.compact"
                            >
                              <span class="pcoded-micon"
                                ><i class="icon-chart"></i
                              ></span>
                          ...
                          <li class="">
                            <a
                              ...
                              data-i18n="nav.page_layout.vertical.sidebar-fixed"
                            >
                              <span class="pcoded-micon"
                                ><i class="icon-chart"></i
                              ></span>
                      ...
                      <li class="pcoded-hasmenu">
                        <a
                          ...
                          data-i18n="nav.page_layout.horizontal.main"
                        >
                          <span class="pcoded-micon"
                            ><i class="icon-pie-chart"></i
                          ></span>
                        ...
                        <ul class="pcoded-submenu">
                          <li class="">
                            <a
                              ...
                              target="_blank"
                              data-i18n="nav.page_layout.horizontal.static-layout"
                            >
                              <span class="pcoded-micon"
                                ><i class="icon-chart"></i
                              ></span>
                          ...
                          <li class="">
                            <a
                              ...
                              target="_blank"
                              data-i18n="nav.page_layout.horizontal.fixed-layout"
                            >
                              <span class="pcoded-micon"
                                ><i class="icon-chart"></i
                              ></span>
                          ...
                          <li class="">
                            <a
                              ...
                              target="_blank"
                              data-i18n="nav.page_layout.horizontal.static-with-icon"
                            >
                              <span class="pcoded-micon"
                                ><i class="icon-chart"></i
                              ></span>
                          ...
                          <li class="">
                            <a
                              ...
                              target="_blank"
                              data-i18n="nav.page_layout.horizontal.fixed-with-icon"
                            >
                              <span class="pcoded-micon"
                                ><i class="icon-chart"></i
                              ></span>
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.navigate.navbar-inverse"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                ...
                <div
                  class="pcoded-navigatio-lavel"
                  data-i18n="nav.category.ui-element"
                  menu-title-theme="theme5"
                >
                  UI Element
                </div>
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        <a
                          href="button.html"
                          data-i18n="nav.basic-components.button"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.basic-components.box-shadow"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="accordion.html"
                          data-i18n="nav.basic-components.collapse–accordion"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.basic-components.generic-class"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="tabs.html"
                          data-i18n="nav.basic-components.tabs"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="color.html"
                          data-i18n="nav.basic-components.color"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.basic-components.label-badge"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.basic-components.progress-bar"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="preloader.html"
                          data-i18n="nav.basic-components.pre-loader"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="list.html"
                          data-i18n="nav.basic-components.list"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="tooltip.html"
                          data-i18n="nav.basic-components.tooltip-popover"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.basic-components.typography"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="other.html"
                          data-i18n="nav.basic-components.other"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.advance-components.main"
                    >
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          href="draggable.html"
                          data-i18n="nav.advance-components.draggable"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="light-box.html"
                          data-i18n="nav.advance-components.light-box"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="modal.html"
                          data-i18n="nav.advance-components.modal"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.advance-components.modal-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.advance-components.notifications"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="notify.html"
                          data-i18n="nav.advance-components.pnotify"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="rating.html"
                          data-i18n="nav.advance-components.rating"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.advance-components.range-slider"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="slider.html"
                          data-i18n="nav.advance-components.slider"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.advance-components.syntax-highlighter"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="tour.html"
                          data-i18n="nav.advance-components.tour"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="treeview.html"
                          data-i18n="nav.advance-components.tree-view"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="nestable.html"
                          data-i18n="nav.advance-components.nestable"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="toolbar.html"
                          data-i18n="nav.advance-components.toolbar"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.advance-components.x-editable"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.extra-components.main"
                    >
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.extra-components.session-timeout"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.extra-components.session-idle-timeout"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="offline.html"
                          data-i18n="nav.extra-components.offline"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.icons.font-awesome"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.icons.simple-line-icon"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.icons.material-design"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.icons.weather-icon"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                ...
                <ul class="pcoded-item pcoded-left-item">
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.form-components.form-elements-advance"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Form-Elements-Advance</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.form-components.form-validation"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="">
                    <a
                      href="form-picker.html"
                      data-i18n="nav.form-pickers.main"
                    >
                      <span class="pcoded-micon"
                  ...
                  <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          href="json-forms/simple-form.html"
                          data-i18n="nav.json-form.simple-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/clubs.html"
                          data-i18n="nav.json-form.clubs-view"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/customer-form.html"
                          data-i18n="nav.json-form.customer-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/customer-profile-display-form.html"
                          data-i18n="nav.json-form.profile-display"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/customer-profile-edit-form.html"
                          data-i18n="nav.json-form.profile-edit"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/customer-profile-read-only.html"
                          data-i18n="nav.json-form.profile-ready-only"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/json-form-fields.html"
                          data-i18n="nav.json-form.form-fields"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/registration-click-validation.html"
                          data-i18n="nav.json-form.registration-validation"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/registration-automatic-validation.html"
                          data-i18n="nav.json-form.automatic-validation"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="json-forms/localized-login.html"
                          data-i18n="nav.json-form.localized-login"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="">
                    <a
                      href="form-masking.html"
                      data-i18n="nav.form-masking.main"
                    >
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.ready-to-use.main"
                    >
                      <span class="pcoded-micon"
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.cloned-elements-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.currency-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.booking-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.booking-multi-steps-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Booking Multi Steps Form</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.comment-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.contact-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.job-application-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.jS-addition-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.login-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.ready-to-use.popup-modal-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.registration-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.review-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.subscribe-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.suggestion-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.ready-to-use.tabs-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                ...
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.bootstrap-table.main"
                    >
                      <span class="pcoded-micon"
                        ><i class="ti-receipt"></i
                      ></span>
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.bootstrap-table.basic-table"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.bootstrap-table.sizing-table"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.bootstrap-table.border-table"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.bootstrap-table.styling-table"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table.styling"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table.server-side"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="dt-plugin.html"
                          data-i18n="nav.data-table.plug-in"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table.data-sources"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.data-table-extensions.main"
                    >
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.autofill"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="pcoded-hasmenu">
                        <a
                          href="javascript:void(0)"
                          data-i18n="nav.data-table-extensions.button.main"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                        ...
                        <ul class="pcoded-submenu">
                          <li class="">
                            <a
                              ...
                              data-i18n="nav.data-table-extensions.button.basic-button"
                            >
                              <span class="pcoded-micon"
                                ><i class="ti-angle-right"></i
                              ></span>
                          ...
                          <li class="">
                            <a
                              href="dt-ext-buttons-flash.html"
                              data-i18n="nav.data-table-extensions.button.flash-button"
                            >
                              <span class="pcoded-micon"
                                ><i class="ti-angle-right"></i
                              ></span>
                          ...
                          <li class="">
                            <a
                              ...
                              data-i18n="nav.data-table-extensions.button.html-data-export"
                            >
                              <span class="pcoded-micon"
                                ><i class="ti-angle-right"></i
                              ></span>
                          ...
                          <li class="">
                            <a
                              href="dt-ext-buttons-print.html"
                              data-i18n="nav.data-table-extensions.button.print-button"
                            >
                              <span class="pcoded-micon"
                                ><i class="ti-angle-right"></i
                              ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.col-reorder"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.fixed-columns"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.fixed-header"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.key-table"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.responsive"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.row-recorder"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.scroller"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.data-table-extensions.select-tbl"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.handson-table.main"
                    >
                      <span class="pcoded-micon"
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.appearance"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.data-operation"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.rows-columns"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.columns-Only"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.cell-features"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.cell-types"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.integrations"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.rows-Only"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.handson-table.utilities"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="">
                    <a
                      ...
                      data-i18n="nav.editable-table.main"
                    >
                      <span class="pcoded-micon"><i class="ti-write"></i></span>
                ...
                <div
                  class="pcoded-navigatio-lavel"
                  data-i18n="nav.category.chart-and-maps"
                  menu-title-theme="theme5"
                >
                  Chart And Maps
                </div>
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)" data-i18n="nav.charts.main">
                      <span class="pcoded-micon"
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.google-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.list-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.float-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.know-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext">Know chart</span>
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.morris-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.nvd3-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.peity-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.radial chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.rickshaw-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.charts.sparkline-chart"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a href="chart-c3.html" data-i18n="nav.charts.c3-chart">
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)" data-i18n="nav.maps.main">
                      <span class="pcoded-micon"
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.maps.google-maps"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="map-api.html"
                          data-i18n="nav.maps.google-map-api"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Google Map Search API</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a href="location.html" data-i18n="nav.maps.location">
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="">
                    <a
                      ...
                      target="_blank"
                      data-i18n="nav.landing-page.main"
                    >
                      <span class="pcoded-micon"
                        ><i class="ti-mobile"></i
                      ></span>
                ...
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.authentication.main"
                    >
                      <span class="pcoded-micon"
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        ...
                        >
                          ...
                          ></span>
                          <span class="pcoded-mtext"
                            >Login Social With Header And Footer</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.login-h-f"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Login With Header And Footer</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.registration-bg-image"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Registration BG Image</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.registration-soc-icon"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Registration Social Icon</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.registration-soc-h-f"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Registration Social With Header And Footer</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.registration-h-f"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Registration With Header And Footer</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.multi-step-registration"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Multi Step Registration</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.forgot-password"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.lock-screen"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          target="_blank"
                          data-i18n="nav.authentication.modal"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.maintenance.main"
                    >
                      <span class="pcoded-micon"
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.maintenance.comming-soon"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.maintenance.offline-ui"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.user-profile.main"
                    >
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          href="timeline.html"
                          data-i18n="nav.user-profile.timeline"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.user-profile.timeline-social"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.user-profile.user-profile"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="user-card.html"
                          data-i18n="nav.user-profile.user-card"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.blog.blog-detail"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="blog-detail-left.html"
                          data-i18n="nav.blog.blog-left-side"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Blog With Left Sidebar</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.blog.blog-right-sidebar"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                          <span class="pcoded-mtext"
                            >Blog With Right Sidebar</span
                          >
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                  ...
                  <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          href="product.html"
                          data-i18n="nav.e-commerce.product"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.e-commerce.product-list"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.e-commerce.product-edit"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.e-commerce.product-detail"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.e-commerce.product-card"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.e-commerce.credit-card-form"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.email.compose-mail"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.email.read-read-mail"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="pcoded-hasmenu">
                        <a
                          href="javascript:void(0)"
                          data-i18n="nav.email.email-template.main"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-email"></i
                          ></span>
                        ...
                        <ul class="pcoded-submenu">
                          <li class="">
                            <a
                              href="email-templates/email-welcome.html"
                          ...
                          <li class="">
                            <a
                              href="email-templates/email-password.html"
                          ...
                          <li class="">
                            <a
                              href="email-templates/email-newsletter.html"
                          ...
                          <li class="">
                            <a
                              href="email-templates/email-launch.html"
                          ...
                          <li class="">
                            <a
                              href="email-templates/email-activation.html"
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.task.task-detail"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.gallery.gallery-grid"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.gallery.masonry-gallery"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.gallery.advance-gallery"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.search.simple-search"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.search.grouping-search"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.job-search.card-view"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.job-search.job-detailed"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="job-find.html"
                          data-i18n="nav.job-search.job-find"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.job-search.job-panel-view"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                ...
                <div
                  class="pcoded-navigatio-lavel"
                  data-i18n="nav.category.extension"
                  menu-title-theme="theme5"
                >
                  Extension
                </div>
                  ...
                  <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          href="ck-editor.html"
                          data-i18n="nav.editor.ck-editor"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.editor.wysiwyg-editor"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.editor.ace-editor"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="summernote.html"
                          data-i18n="nav.editor.summer-note-editor"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.editor.long-press-editor"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                ...
                <ul class="pcoded-item pcoded-left-item">
                    ...
                    <ul class="pcoded-submenu">
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.invoice.invoice-summery"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.invoice.invoice-list"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.event-calendar.main"
                    >
                      <span class="pcoded-micon"
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          ...
                          data-i18n="nav.full-calendar.full-calendar"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="">
                    <a
                      ...
                      data-i18n="nav.image-cropper.main"
                    >
                  ...
                  <li class="pcoded-hasmenu">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.internationalize.main"
                    >
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a
                          href="internationalization/internationalization-after-init.html"
                          data-i18n="nav.internationalize.after-init"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="internationalization/internationalization-fallback.html"
                          data-i18n="nav.internationalize.fallback"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="internationalization/internationalization-on-init.html"
                          data-i18n="nav.internationalize.on-int"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="internationalization/internationalization-resources.html"
                          data-i18n="nav.internationalize.resources"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                      ...
                      <li class="">
                        <a
                          href="internationalization/internationalization-xhr-backend.html"
                          data-i18n="nav.internationalize.xhr-backend"
                        >
                          <span class="pcoded-micon"
                            ><i class="ti-angle-right"></i
                          ></span>
                  ...
                  <li class="">
                    <a
                      ...
                      data-i18n="nav.change-loges.main"
                    >
                ...
                <ul class="pcoded-item pcoded-left-item">
                  ...
                  <li class="">
                    <a
                      href="javascript:void(0)"
                      data-i18n="nav.disabled-menu.main"
                      class="disabled"
                    >
                ...
                <div
                  class="pcoded-navigatio-lavel"
                  data-i18n="nav.category.support"
                  menu-title-theme="theme5"
                >
                  Support
                </div>
                <ul class="pcoded-item pcoded-left-item">
                  <li class="">
                    <a
                      href="http://flatable.phoenixcoded.net/doc"
                      data-i18n="nav.documentation.main"
                      target="_blank"
                    >
                  ...
                  <li class="">
                    <a
                      href="https://support.phoenixcoded.net/#/home"
                      target="_blank"
                              ...
                              <div class="row-table">
                                <div class="col-sm-6 card-block-big br">
                                  <div class="row">
                                    <div class="col-sm-4">
                                      <i
                                        class="icofont icofont-files text-info"
                                      ></i>
                                    </div>
                                    <div class="col-sm-8 text-center">
                                      <h5>2000 +</h5>
                                  ...
                                  <ol>
                                    <li class="selected" data-date="16/01/2014">
                                      ...
                                      <p class="m-b-0">
                                        ...
                                        officia, fugit recusandae ipsa, quia
                                        velit nulla adipisci? Consequuntur
                                        aspernatur at, eaque hic repellendus sit
                                        dicta consequatur quae, ut harum ipsam
                                        molestias maxime non nisi reiciendis
                                        eligendi! Doloremque quia pariatur harum
                                        ea amet quibusdam quisquam, quae,
                                        temporibus dolores porro doloribus.Illum
                                        praesentium officia, fugit recusandae
                                        ipsa, quia velit nulla adipisci?
                                        Consequuntur aspernatur at,
                                      </p>
                                      <div class="m-t-20 d-timeline-btn">
                                        <button class="btn btn-danger">
                                          Read More
                                        </button>
                                        <button class="btn btn-primary f-right">
                                          <i
                                            class="icofont icofont-plus m-r-0"
                                          ></i>
                                        </button>
                                      </div>
                                    </li>
                              ...
                              <div class="card card-border-primary">
                                ...
                                <div class="card-footer">
                                  ...
                                  <div class="task-board m-0">
                                    <a
                                      href="http://flatable.phoenixcoded.net/html/invoice.html"
                                      class="btn btn-info btn-mini b-none"
                                      ><i
                                        class="icofont icofont-eye-alt m-0"
                                      ></i
                                    ></a>
                                    ...
                                    <div class="dropdown-secondary dropdown">
                                      ...
                                      >
                                        <a
                                          ...
                                          href="#!"
                                          ><i
                                            class="icofont icofont-ui-alarm"
                                          ></i>
                                          Print Invoice</a
                                        >
                                        <a
                                          ...
                                          href="#!"
                                          ><i
                                            class="icofont icofont-attachment"
                                          ></i>
                                          Download invoice</a
                                        >
                                        <div class="dropdown-divider"></div>
                            ...
                            <div class="col-lg-12">
                              <div class="card table-card group-widget">
                                <div class="">
                                  <div class="row-table">
                                    <div
                                      class="col-sm-4 bg-primary card-block-big"
                                    >
                                    ...
                                    >
                                      <i
                                        class="icofont icofont-video-clapper"
                                      ></i>
                                      <p>1,743</p>
                                    </div>
                                    <div
                            ...
                            <div class="card-block">
                              ...
                              <div class="media">
                                <img
                                  class="
                                    d-flex
                                    mr-3
                                    img-circle img-40 img-thumbnail
                                  "
                              ...
                              <div class="media col-sm-8 offset-md-4">
                                <div class="media-body receive-chat">
                                  ...
                                  <span class="time">
                                    <i class="icofont icofont-check m-r-5"></i
                                    >Seen 2 sec ago
                                  </span>
                                </div>
                              </div>
    ...
    <script
      type="text/javascript"
      src="../bower_components/modernizr/feature-detects/css-scrollbars.js"
    ></script>
    ...
    <script
      type="text/javascript"
      src="../bower_components/i18next-xhr-backend/i18nextXHRBackend.min.js"
    ></script>
    <script
      type="text/javascript"
      src="../bower_components/i18next-browser-languagedetector/i18nextBrowserLanguageDetector.min.js"
    ></script>
    <script
      type="text/javascript"
      src="../bower_components/jquery-i18next/jquery-i18next.min.js"
    ></script>
