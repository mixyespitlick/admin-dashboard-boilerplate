                                    ...
                                    <ul class="show-notification row">
                                        <li class="col-sm-3">
                                            ...
                                            <ul class="mega-menu-links">
                                                <li>
                                                    <a href="form-elements-component.html">Form Elements</a>
                                                </li>
                                            ...
                                            <ul class="mega-mailbox">
                                                ...
                                                <li>
                                                    <a href="#" class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h5>Drop-box</h5>
                                                            <small class="text-muted">Store large amount of data in
                                                                one-box only
                                                            </small>
                                                        </div>
                                                    </a>
                                        ...
                                        <li class="col-sm-3">
                                            ...
                                            <div class="mega-menu-contact">
                                                ...
                                                <div class="form-group row">
                                                    <label for="example-search-input"
                                                        class="col-3 col-form-label">Contact</label>
                                                    <div class="col-9">
                                                        <input class="form-control" type="number"
                                                            placeholder="+91-9898989898" id="example-search-input" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar" pcoded-header-position="relative">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                                        ...
                                        <li class="">
                                            <a href="dashboard-ecommerce.html">
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.dash.ecommerce">Ecommerce</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.ui-element"
                                menu-title-theme="theme5">
                                UI Element
                            </div>
                            <ul class="pcoded-item pcoded-left-item">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.tables"
                                menu-title-theme="theme5">
                                Tables
                            </div>
                            <ul class="pcoded-item pcoded-left-item">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="chart-google.html" data-i18n="nav.charts.google-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-echart.html" data-i18n="nav.charts.echarts">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-chartjs.html" data-i18n="nav.charts.chartjs">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-list.html" data-i18n="nav.charts.list-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-float.html" data-i18n="nav.charts.float-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-knob.html" data-i18n="nav.charts.know-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-morris.html" data-i18n="nav.charts.morris-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-nvd3.html" data-i18n="nav.charts.nvd3-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-peity.html" data-i18n="nav.charts.peity-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-radial.html" data-i18n="nav.charts.radial chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-rickshaw.html" data-i18n="nav.charts.rickshaw-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="chart-sparkline.html" data-i18n="nav.charts.sparkline-chart">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="map-google.html" data-i18n="nav.maps.google-maps">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="map-vector.html" data-i18n="nav.maps.vector-map">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="">
                                            <a href="map-api.html" data-i18n="nav.maps.google-map-api">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                ...
                                <li class="">
                                    <a href="landingpage/index.html" target="_blank" data-i18n="nav.landing-page.main">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.app" menu-title-theme="theme5">
                                App
                            </div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.extension"
                                menu-title-theme="theme5">
                                Extension
                            </div>
                            <ul class="pcoded-item pcoded-left-item">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="http://flatable.phoenixcoded.net/doc" data-i18n="nav.documentation.main"
                                        target="_blank">
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                                                ...
                                                                <div class="events-wrapper">
                                                                    <div class="events">
                                                                        <ol>
                                                                            ...
                                                                            <li>
                                                                                <a href="#0" data-date="28/02/2014">28
                                                                                    Feb</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="20/04/2014">20
                                                                                    Mar</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="20/05/2014">20
                                                                                    May</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="09/07/2014">09
                                                                                    Jul</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="30/08/2014">30
                                                                                    Aug</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="15/09/2014">15
                                                                                    Sep</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="01/11/2014">01
                                                                                    Nov</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="10/12/2014">10
                                                                                    Dec</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="19/01/2015">29
                                                                                    Jan</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#0" data-date="03/03/2015">3
                                                                                    Mar</a>
                                                                            </li>
                                                                        </ol>
                                                                    ...
                                                                    <li class="selected" data-date="16/01/2014">
                                                                        ...
                                                                        <div class="m-t-20 d-timeline-btn">
                                                                            ...
                                                                            <button class="btn btn-primary f-right">
                                                                                <i
                                                                                    class="icofont icofont-plus m-r-0"></i>
                                                                            </button>
                                                                        </div>
                                                                    </li>
                                      ...
                                      " type="button" id="dropdown6" data-toggle="dropdown" aria-haspopup="true"
                                        ...
                                        " href="#!"><span class="point-marker bg-danger"></span>Pending</a>
                                                                        <a class="
                                          dropdown-item
                                          waves-light waves-effect
                                        " href="#!"><span class="point-marker bg-warning"></span>Paid</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a class="
                                          dropdown-item
                                          waves-light waves-effect
                                          active
                                        " href="#!"><span class="point-marker bg-success"></span>On Hold</a>
                                                                        <a class="
                                          dropdown-item
                                          waves-light waves-effect
                                        " href="#!"><span class="point-marker bg-info"></span>Canceled</a>
                                                                    </div>
                                                            ...
                                                            <div class="card-footer">
                                                                <div class="task-list-table">
                                                                    <p class="task-due">
                                                                        <strong> Due : </strong><strong
                                                                            class="label label-success">23
                                                                            hours</strong>
                                                                    </p>
                                                                </div>
                                                                <div class="task-board m-0">
                                                                    <a href="http://flatable.phoenixcoded.net/html/invoice.html"
                                        ...
                                        " type="button" id="dropdown3" data-toggle="dropdown" aria-haspopup="true"
                                          ...
                                          "></i>
                                            ...
                                            dropdown-item
                                            waves-light waves-effect
                                          " href="#!"><i class="icofont icofont-ui-alarm"></i>
                                                                                Print Invoice</a>
                                                                            <a class="
                                            dropdown-item
                                            waves-light waves-effect
                                          " href="#!"><i class="icofont icofont-attachment"></i>
                                                                                Download invoice</a>
                                                                            <div class="dropdown-divider"></div>
                                                                            <a class="
                                            dropdown-item
                                          ...
                                          " href="#!"><i class="
                                            ...
                                            dropdown-item
                                            waves-light waves-effect
                                          " href="#!"><i class="icofont icofont-ui-edit"></i>
                                                                                Remove Invoice</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                  ...
                                  " src="assets/images/user-card/img-round1.jpg" alt="Generic placeholder image" />
                                                        ...
                                                        <div class="media col-sm-8 offset-md-4">
                                                            <div class="media-body receive-chat">
                                                                ...
                                                                <span class="time">
                                                                    <i class="icofont icofont-check m-r-5"></i>Seen 2
                                                                    sec ago
                                                                </span>
                                                            </div>
                                                        </div>
